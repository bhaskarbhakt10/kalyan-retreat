                                ...
                                <tr class="odd:bg-white  even:bg-gray-50 border-b hover:bg-gray-100  text-black transition-all">
                                    ...
                                    <td class="py-3 px-3">
                                        <div class="flex gap-x-2">
                                            ...
                                            <a href="view-pdf.php?q=<?php echo preg_replace('/#/','__',$row['Register_ID']);?>" class="print-pdf block text-center cursor-pointer md:px-2 sm:py-1 sm:px-1 sm:py-1 px-2 py-1 rounded-md border-2 border-purple-600 text-purple-600 hover:bg-purple-300 transition ease-in delay-10 hover:text-white max-w-[100px] w-full" alt="View Pdf">
